...
- Update model upload history -  sentence-transformers/all-MiniLM-L6-v2 (v.1.0.9)(TORCH_SCRIPT) by @conggguan ([#30](https://github.com/conggguan/opensearch-py-ml/pull/30))
