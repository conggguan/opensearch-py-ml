...
- Update model upload history -  opensearch-project/opensearch-neural-sparse-encoding-v1 (v.1.0.3)(TORCH_SCRIPT) by @conggguan ([#22](https://github.com/conggguan/opensearch-py-ml/pull/22))
