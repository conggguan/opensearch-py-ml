...
- Update model upload history -  sentence-transformers/all-MiniLM-L6-v2 (v.1.0.0)(TORCH_SCRIPT) by @conggguan ([#44](https://github.com/conggguan/opensearch-py-ml/pull/44))
